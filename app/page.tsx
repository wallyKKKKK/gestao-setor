        ...
        {activeTab === 'DASHBOARD' ? (
          <div className="mt-6 space-y-6 animate-in fade-in duration-500">
            ...
            <div className="bg-white p-12 rounded-[48px] border-4 border-slate-900 shadow-[15px_15px_0px_0px_rgba(15,23,42,1)] text-center">
               <p className="text-[10px] font-black uppercase text-slate-400 mb-4 tracking-[0.2em]">Taxa de Eficiência {dashFilter}</p>
               <h3 className="text-9xl font-black mb-8 tracking-tighter text-slate-900">{stats.porcentagem}%</h3>
               <div className="w-full bg-slate-100 h-16 rounded-3xl border-4 border-slate-900 overflow-hidden shadow-inner p-1">
                  <div className="bg-gradient-to-r from-blue-600 to-green-500 h-full rounded-2xl transition-all duration-1000 shadow-lg" style={{ width: `${stats.porcentagem}%` }} />
               </div>
            </div>
          </div>
        ) : (
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-end border-t border-slate-100 pt-6">
                  ...
                  <div className="md:col-span-4 h-full">
                    <button onClick={addTask} className="w-full h-[calc(100%-10px)] bg-blue-600 hover:bg-[#0F172A] text-white rounded-[24px] font-black uppercase tracking-widest transition-all duration-500 flex flex-col items-center justify-center gap-3 shadow-[0_10px_30px_rgba(37,99,235,0.3)] group active:scale-95">
                      <div className="bg-white/20 p-3 rounded-full group-hover:rotate-90 transition-transform duration-500"><Plus size={32} strokeWidth={3} /></div>
